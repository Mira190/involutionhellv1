...
description: "LeetCode 1545. 找出第 N 个二进制字符串中的第 K 位 题解 — 递归与数学翻转解法，通过分析字符串构造规律（S₁=0，后续由前序+1+反转取反前序组成），将第 K 位分为左半、中间、右半三类递归求解，避免暴力生成导致内存溢出。适合准备面试、刷递归与位运算题型的算法学习者。"
